      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8 mb-24">
        <div className="text-center max-w-4xl mx-auto">
          <div className={`transition-all duration-700 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            ...
            <p className={`text-lg md:text-xl text-foreground/80 max-w-2xl mx-auto mb-8 transition-all delay-300 duration-700 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
              Concevez un site qui vous démarque. À prix attractif. Résultats exceptionnels.
            </p>
